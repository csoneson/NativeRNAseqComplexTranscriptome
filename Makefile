...
flair := /home/charlotte/software/flair20181216/flair.py
bam2bed12 := /home/charlotte/software/flair20181216/bin/bam2Bed12.py
flair2 := /home/charlotte/software/flair20190418/flair.py
...
sqantiqc := /home/charlotte/software/sqanti/sqanti_qc.py
...
gmapidx := $(annotdir)/GMAP/Ensembl_GRCh38.90_gmap/Ensembl_GRCh38.90_gmap_idx
...
## NA12878 consortium sample
NA12878publicsamples := NA12878-DirectRNA.pass.dedup

.PHONY: all flairres nanoporeres illuminares manuscript sirv na12878
...
$(foreach D,RNA001 DCS108 pilot HEK293RNA Illumina,$(D)/sqanti/$(D)_WT/$(D)_WT_report.pdf) \
$(foreach D,$(datasets),$(D)/flair_round2_ilmnjunc/$(D)_WT/$(D)_WT_minimap_genome_s_primary_flair_correct_ilmnjunc_all_corrected.psl) \
$(foreach D,$(datasets),$(D)/flair_round2/$(D)_WT/$(D)_WT_minimap_genome_s_primary_flair_correct_all_corrected.psl) \
$(foreach D,$(datasets),$(D)/flair_round2_ilmnjunc/$(D)_WT/$(D)_WT_minimap_genome_s_primary_flair_collapse_ilmnjunc.isoforms.psl) \
$(foreach D,$(datasets),$(D)/flair_round2/$(D)_WT/$(D)_WT_minimap_genome_s_primary_flair_collapse.isoforms.psl) \
$(foreach D,$(datasets),$(D)/flair_round2/$(D)_WT/$(D)_WT_minimap_genome_s_primary_flair_collapse.isoforms.fa) \
$(foreach D,$(datasets),$(D)/sqanti_round2_ilmnjunc/$(D)_WT/$(D)_WT_ilmnjunc_report.pdf) \
$(foreach D,$(datasets),$(D)/sqanti_round2/$(D)_WT/$(D)_WT_report.pdf) \
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(D)/flair_round2/$(S)/$(S)_minimap_genome_s_primary_flair_collapse.isoforms.gffcompare)) \
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(D)/flair_round2_ilmnjunc/$(S)/$(S)_minimap_genome_s_primary_flair_collapse_ilmnjunc.isoforms.gffcompare)) \
$(foreach D,$(datasets),$(D)/flair_round2/$(D)_WT/plots/$(D)_WT_flair_round2_vs_annotation.rds) \
...
$(foreach D,$(datasets),$(D)/FASTQgenomenotxome/reads_aligning_to_genome_but_not_txome.rds) \
$(foreach D,$(datasets),$(foreach S,$($(D)samples),$(D)/FASTQgenomenotxome/$(S)_genomenotxome.fastq.gz)) \
$(foreach D,$(datasets),$(foreach S,$($(D)samples),$(D)/FASTQgenomenotxome/$(S)_genomenotxome_fastqc.html)) \
RNA001/tailfindr/wt_1_RNA001_tailfindr.csv
...
manuscript_results_figures/figures/txcov_subsampling/txcov_na12878public.rds \
manuscript_results_figures/figures/rseqc_coverage/rseqc_coverage.rds \
manuscript_results_figures/figures/sqanti_round2_summary/sqanti_round2_summary.rds \
...
manuscript_results_figures/figures/flair_round2_summary/flair_round2_summary.rds \
manuscript_results_figures/figures/polya_tails/polya_tails.rds \
manuscript_results_figures/figures/nbr_junctions_per_read_illumina/nbr_junctions_per_read_illumina.rds \
manuscript_results_figures/figures/gc_content_genomenotxome/gc_content_genomenotxome.rds
...
na12878: $(foreach S,$(NA12878publicsamples),NA12878public/minimap2genome/$(S)/$(S)_minimap_genome_s.bam) \
$(foreach S,$(NA12878publicsamples),NA12878public/minimap2txome/$(S)/$(S)_minimap_txome.bam) \
$(foreach S,$(NA12878publicsamples),NA12878public/minimap2txome_p0.99/$(S)/$(S)_minimap_txome_p0.99.bam) \
NA12878public/output/NA12878public_nbr_reads.rds
...
endef
$(foreach D,HEK293RNA RNA001 NA12878public,$(foreach S,$($(D)samples),$(eval $(call u2trule,$(D),$(S)))))

## ========================================================================================= ##
## Run tailfindr for one RNA001 sample
## ========================================================================================= ##
...
## Process junctions seen in the Illumina data for use with FLAIR
Illumina/STAR/Illumina_WT/Illumina_WT_SJ.out.tab: $(foreach I,$(IlluminaWTsamples),Illumina/STAR/$(I)/$(I)_SJ.out.tab) \
$(Rscriptdir)/summarize_star_sjdbs.R
	mkdir -p $(@D)
	$(R) "--args sjdbfiles='$(subst $(space),$(comma),$(strip $(foreach I,$(IlluminaWTsamples),Illumina/STAR/$(I)/$(I)_SJ.out.tab)))' min_unique=5 outtxt='$@'" $(Rscriptdir)/summarize_star_sjdbs.R Illumina/Rout/summarize_star_sjdbs_WT.Rout
...
define flairfarule
$(1)/flair/$(2)/$(2)_minimap_genome_s_primary_flair_collapse.isoforms.fa: $(1)/flair/$(2)/$(2)_minimap_genome_s_primary_flair_collapse.isoforms.psl
	touch $$@
endef
$(foreach D,FGCZ,$(foreach S,$($(D)samples),$(eval $(call flairfarule,$(D),$(S)))))
$(foreach D,DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 FGCZ_PCS109_GridION,$(foreach S,$($(D)samples),$(eval $(call flairfarule,$(D),$(S)))))
$(foreach D,HEK293RNA RNA001,$(foreach S,$($(D)samples),$(eval $(call flairfarule,$(D),$(S)))))
$(foreach D,FGCZ DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 HEK293RNA RNA001 FGCZ_PCS109_GridION,$(eval $(call flairfarule,$(D),$(D)_all)))
$(foreach D,FGCZ DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 HEK293RNA RNA001 FGCZ_PCS109_GridION,$(eval $(call flairfarule,$(D),$(D)_WT)))
...
$(1)/flair/$(2)/$(2)_minimap_genome_s_primary_flair_collapse.isoforms.gtf $(gtf) $(Rscriptdir)/plot_compare_flair_annotation.R 
	mkdir -p $$(@D)
	mkdir -p $(1)/Rout
	$(R) "--args annotatedGtf='$(gtf)' flairGtf='$$(word 2,$$^)' dataSet='$(2)' outDir='$$(@D)' seed=1 nPlots=250 sqanticlass='' flairTmap='$$<.$(2)_minimap_genome_s_primary_flair_collapse.isoforms.gtf.tmap' outrds='$$@'" $(Rscriptdir)/plot_compare_flair_annotation.R $(1)/Rout/plot_compare_flair_annotation_$(2).Rout
endef
$(foreach D,$(datasets),$(eval $(call flairplotrule,$(D),$(D)_WT)))

## Run SQANTI to compare with reference gtf
## This needs to be run in the py27 environment
## source activate py27
define sqantirule
$(1)/sqanti/$(2)/$(2)_report.pdf: $(1)/flair/$(2)/$(2)_minimap_genome_s_primary_flair_collapse.isoforms.fa $(gtf) $(genome) \
$(foreach I,$(IlluminaWTsamples),Illumina/STAR/$(I)/$(I)_SJ.out.tab)
	mkdir -p $$(@D)
	$(sqantiqc) -x $(gmapidx) -t $(nthreads) -o $(2) -d $$(@D) \
	-c $$(subst $$(space),$$(comma),$$(strip $$(foreach I,$$(IlluminaWTsamples),Illumina/STAR/$$(I)/$$(I)_SJ.out.tab))) $$< $(gtf) $(genome)
endef
$(foreach D,DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 FGCZ_PCS109_GridION FGCZ RNA001,$(foreach S,$(D)_WT,$(eval $(call sqantirule,$(D),$(S)))))
...
$(1)/sqanti/$(2)/$(2)_report.pdf: $(1)/flair/$(2)/$(2)_minimap_genome_s_primary_flair_collapse.isoforms.fa $(gtf) $(genome)
	...
	$$< $(gtf) $(genome)
endef
$(foreach D,HEK293RNA,$(foreach S,$(D)_WT,$(eval $(call sqantirule2,$(D),$(S)))))

## ----------------------------------------------------------------------------------------- ##
## New version of FLAIR (April 2019)
## ----------------------------------------------------------------------------------------- ##
## source activate py27
define flaircorrectrulenew
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_correct$(3)_all_corrected.psl: \
$(1)/minimap2genome/$(2)/$(2)_minimap_genome_s_primary.bed $(flair2) $(gtf) $(STARindex)/SA $(5)
	mkdir -p $$(@D)
	cd $$(@D) && python $(flair2) correct -f $(gtf) -c $(STARindex)/chrNameLength.txt \
	-q $(basedir)/$(1)/minimap2genome/$(2)/$(2)_minimap_genome_s_primary.bed \
	-t $(nthreads) -w 10 -o $(2)_minimap_genome_s_primary_flair_correct$(3) -n $(4) $(5)
endef
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flaircorrectrulenew,$(D),$(S),,,))))
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flaircorrectrulenew,$(D),$(S),_ilmnjunc,-j,$(basedir)/Illumina/STAR/Illumina_WT/Illumina_WT_SJ.out.tab))))

define flaircollapserulenew
$(1)/flair_round2$(5)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(5).isoforms.psl: \
$(1)/FASTQ$(4)/$(2).$(3).gz $(1)/flair_round2$(5)/$(2)/$(2)_minimap_genome_s_primary_flair_correct$(5)_all_corrected.psl $(promoterbed) \
$(flair2) $(gtf) $(genome) $(minimap2)
	mkdir -p $$(@D)
	cd $$(@D) && python $(flair2) collapse -r $(basedir)/$$< -q $(2)_minimap_genome_s_primary_flair_correct$(5)_all_corrected.psl \
	-g $(genome) -f $(gtf) -m $(minimap2) -t $(nthreads) -o $(2)_minimap_genome_s_primary_flair_collapse$(5) -s 3 \
	-p $(basedir)/$(promoterbed) -b $(bedtools)
endef
$(foreach D,$(datasets),$(eval $(call flaircollapserulenew,$(D),$(D)_WT,fastq,merged,)))
$(foreach D,$(datasets),$(eval $(call flaircollapserulenew,$(D),$(D)_WT,fastq,merged,_ilmnjunc)))

define flairfarulenew
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fa: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.psl
	touch $$@
endef
$(foreach D,$(datasets),$(eval $(call flairfarulenew,$(D),$(D)_WT,)))
$(foreach D,$(datasets),$(eval $(call flairfarulenew,$(D),$(D)_WT,_ilmnjunc)))

## Replace ; in fa and psl files by . (otherwise can't be parsed by standard tools)
define flairfarulenew2
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixed.fa: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fa
	sed 's/;/./' $$< > $$@
endef
$(foreach D,$(datasets),$(eval $(call flairfarulenew2,$(D),$(D)_WT,)))
$(foreach D,$(datasets),$(eval $(call flairfarulenew2,$(D),$(D)_WT,_ilmnjunc)))

define flairpslrulenew2
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixedsc.psl: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.psl
	sed 's/;/./' $$< > $$@
endef
$(foreach D,$(datasets),$(eval $(call flairpslrulenew2,$(D),$(D)_WT,)))
$(foreach D,$(datasets),$(eval $(call flairpslrulenew2,$(D),$(D)_WT,_ilmnjunc)))

## Convert collapsed psl file to gff
define flairpslgffrulenew
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixedsc.gff: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixedsc.psl
	$(psl2gff) $$<
endef
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairpslgffrulenew,$(D),$(S),))))
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairpslgffrulenew,$(D),$(S),_ilmnjunc))))

## Convert gff to gtf compatible with gffcompare
define flairgffgtfrulenew
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gtf: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixedsc.gff \
$(Rscriptdir)/gff2gtf.R
	$(R) "--args gff='$$<' gtf='$$@'" $(Rscriptdir)/gff2gtf.R $(1)/Rout/gff2gtf_$(2)_round2$(3).Rout
endef
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairgffgtfrulenew,$(D),$(S),))))
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairgffgtfrulenew,$(D),$(S),_ilmnjunc))))

## Run gffcompare to compare with reference gtf
define flairgffcomparerulenew
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gffcompare: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gtf \
$(gtf)
	$(gffcompare) -o $$@ -r $(gtf) -R $$<
endef
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairgffcomparerulenew,$(D),$(S),))))
$(foreach D,$(datasets),$(foreach S,$(D)_WT,$(eval $(call flairgffcomparerulenew,$(D),$(S),_ilmnjunc))))

## Plot some of the collapsed transcripts and the closest annotated one
define flairplotrulenew
$(1)/flair_round2$(3)/$(2)/plots/$(2)$(3)_flair_round2_vs_annotation.rds: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gffcompare \
$(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gtf $(1)/sqanti_round2$(3)/$(2)/$(2)_report.pdf $(gtf) $(Rscriptdir)/plot_compare_flair_annotation.R 
	mkdir -p $$(@D)
	mkdir -p $(1)/Rout
	$(R) "--args annotatedGtf='$(gtf)' flairGtf='$$(word 2,$$^)' dataSet='$(2)' outDir='$$(@D)' seed=1 nPlots=250 sqanticlass='$(1)/sqanti_round2$(3)/$(2)/$(2)_classification.txt' flairTmap='$$<.$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.gtf.tmap' outrds='$$@'" $(Rscriptdir)/plot_compare_flair_annotation.R $(1)/Rout/plot_compare_flair_round2_annotation_$(2)$(3).Rout
endef
$(foreach D,$(datasets),$(eval $(call flairplotrulenew,$(D),$(D)_WT,)))

define sqantirulenew
$(1)/sqanti_round2$(3)/$(2)/$(2)$(3)_report.pdf: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixed.fa $(gtf) $(genome) \
$(foreach I,$(IlluminaWTsamples),Illumina/STAR/$(I)/$(I)_SJ.out.tab)
	mkdir -p $$(@D)
	$(sqantiqc) -x $(gmapidx) -t $(nthreads) -o $(2)$(3) -d $$(@D) \
	-c $$(subst $$(space),$$(comma),$$(strip $$(foreach I,$$(IlluminaWTsamples),Illumina/STAR/$$(I)/$$(I)_SJ.out.tab))) $$< $(gtf) $(genome)
endef
$(foreach D,DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 FGCZ_PCS109_GridION FGCZ RNA001,$(foreach S,$(D)_WT,$(eval $(call sqantirulenew,$(D),$(S),))))
$(foreach D,DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 FGCZ_PCS109_GridION FGCZ RNA001,$(foreach S,$(D)_WT,$(eval $(call sqantirulenew,$(D),$(S),_ilmnjunc))))

define sqantirulenew2
$(1)/sqanti_round2$(3)/$(2)/$(2)$(3)_report.pdf: $(1)/flair_round2$(3)/$(2)/$(2)_minimap_genome_s_primary_flair_collapse$(3).isoforms.fixed.fa $(gtf) $(genome)
	mkdir -p $$(@D)
	$(sqantiqc) -x $(gmapidx) -t $(nthreads) -o $(2)$(3) -d $$(@D) $$< $(gtf) $(genome)
endef
$(foreach D,HEK293RNA,$(foreach S,$(D)_WT,$(eval $(call sqantirulenew2,$(D),$(S),))))
$(foreach D,HEK293RNA,$(foreach S,$(D)_WT,$(eval $(call sqantirulenew2,$(D),$(S),_ilmnjunc))))
...
$(foreach P,0.9 0.95 0.99,$(foreach D,HEK293RNA RNA001 NA12878public,$(foreach S,$($(D)samples),$(eval $(call minimap2ptxrule,$(D),$(S),$(P),fastq,dna)))))
...
## ========================================================================================= ##
## Get reads aligning to genome but not txome for each sample
## ========================================================================================= ##
define genomenotxomerule
$(1)/FASTQgenomenotxome/reads_aligning_to_genome_but_not_txome.rds: $(1)/output/$(1)_nbr_reads.rds $(Rscriptdir)/get_reads_aligning_to_genome_but_not_txome.R
	mkdir -p $$(@D)
	mkdir -p $(1)/Rout
	$(R) "--args nbrreadsrds='$$<' outdir='$$(@D)'" $(Rscriptdir)/get_reads_aligning_to_genome_but_not_txome.R $(1)/Rout/get_reads_aligning_to_genome_but_not_txome.Rout
endef
$(foreach D,$(datasets),$(eval $(call genomenotxomerule,$(D))))

define genomenotxomerule2
$(1)/FASTQgenomenotxome/$(2)_genomenotxome.fastq.gz: $(1)/FASTQ$(4)/$(2).$(3).gz \
$(1)/FASTQgenomenotxome/reads_aligning_to_genome_but_not_txome.rds
	mkdir -p $$(@D)
	$(seqkit) grep --pattern-file $(1)/FASTQgenomenotxome/$(2)_reads_aligning_to_genome_but_not_txome.txt $$< | gzip > $$@
endef
$(foreach D,DCS108 NSK007 pilot FGCZ_PCS109 FGCZ_SQK_PCS109 FGCZ_PCS109_GridION,$(foreach S,$($(D)samples),$(eval $(call genomenotxomerule2,$(D),$(S),fastq,))))
$(foreach D,FGCZ,$(foreach S,$($(D)samples),$(eval $(call genomenotxomerule2,$(D),$(S),FASTQ,))))
$(foreach D,HEK293RNA RNA001 NA12878public,$(foreach S,$($(D)samples),$(eval $(call genomenotxomerule2,$(D),$(S),fastq,dna))))

define genomenotxomefastqcrule
$(1)/FASTQgenomenotxome/$(2)_genomenotxome_fastqc.html: $(1)/FASTQgenomenotxome/$(2)_genomenotxome.fastq.gz
	mkdir -p $$(@D)
	$(fastqc) -o $$(@D) -t $(nthreads) $$<
endef
$(foreach D,$(datasets),$(foreach S,$($(D)samples),$(eval $(call genomenotxomefastqcrule,$(D),$(S)))))
...
define starsjdbrule
Illumina/STAR/$(1)/$(1)_SJ.out.tab: Illumina/STAR/$(1)/$(1)_Aligned.sortedByCoord.out.bam
	touch $$@
endef
$(foreach S,$(Illuminasamples),$(eval $(call starsjdbrule,$(S))))
...
endef
$(foreach S,Illumina_WT,$(eval $(call sqantiilmnrule,$(S))))
...
define nbrreadsrule2
$(1)/output/$(1)_nbr_reads.rds: \
$(foreach S,$($(1)samples),$(1)/minimap2txome_p0.99/$(S)/$(S)_minimap_txome_p0.99.bam) \
$(Rscriptdir)/get_nbr_reads_NA12878public.R
	mkdir -p $$(@D)
	mkdir -p $(1)/Rout
...
datasets_to_include.mk
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args tx2gene='$(tx2gene)' datasets='$(datasetsmsc)' conditions='$(conditionsmsc)' txcna12878='manuscript_results_figures/figures/txcov_subsampling/txcov_na12878public.rds' txcercc='manuscript_results_figures/figures/txcov_subsampling/txcov_ercc.rds' txcsirv='manuscript_results_figures/figures/txcov_subsampling/txcov_sirv.rds' ilmnnplength='manuscript_results_figures/figures/illumina_nanopore_lengths_all_datasets/illumina_nanopore_lengths_all_datasets.rds' outrds='$@'" manuscript_results_figures/Rscripts/plot_txcov_subsampling.R manuscript_results_figures/Rout/plot_txcov_subsampling.Rout

manuscript_results_figures/figures/txcov_subsampling/txcov_na12878public.rds: NA12878public/output/NA12878public_nbr_reads.rds \
manuscript_results_figures/Rscripts/plot_txcov_sirv.R 
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args dataset='NA12878public' labels='A,B' title='NA12878' outrds='$@'" manuscript_results_figures/Rscripts/plot_txcov_sirv.R manuscript_results_figures/Rout/plot_txcov_na12878.Rout

manuscript_results_figures/figures/txcov_subsampling/txcov_sirv.rds: dRNA_paper/output/dRNA_paper_nbr_reads.rds \
manuscript_results_figures/Rscripts/plot_txcov_sirv.R 
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args dataset='dRNA_paper' labels='A,B' title='SIRV' outrds='$@'" manuscript_results_figures/Rscripts/plot_txcov_sirv.R manuscript_results_figures/Rout/plot_txcov_sirv.Rout

manuscript_results_figures/figures/txcov_subsampling/txcov_ercc.rds: dRNA_paper_ERCC/output/dRNA_paper_ERCC_nbr_reads.rds \
manuscript_results_figures/Rscripts/plot_txcov_sirv.R 
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args dataset='dRNA_paper_ERCC' labels='C,D' title='ERCC' outrds='$@'" manuscript_results_figures/Rscripts/plot_txcov_sirv.R manuscript_results_figures/Rout/plot_txcov_ercc.Rout
...
Illumina/output/Illumina_all_abundances.rds \
manuscript_results_figures/Rscripts/plot_flair_round2_summary.R \
manuscript_results_figures/Rscripts/remap_sample_names.R \
datasets_to_include.mk
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args datasets='$(datasetsmsc)' conditions='$(conditionsmsc)' outrds='$@'" manuscript_results_figures/Rscripts/plot_flair_round2_summary.R manuscript_results_figures/Rout/plot_flair_round2_summary.Rout

manuscript_results_figures/figures/sqanti_summary/sqanti_summary.rds: \
$(foreach D,$(datasetsms) Illumina,$(foreach S,$(D)_WT,$(D)/sqanti/$(S)/$(S)_report.pdf)) \
Illumina/output/Illumina_all_abundances.rds \
manuscript_results_figures/Rscripts/plot_sqanti_summary.R \
manuscript_results_figures/Rscripts/remap_sample_names.R \
datasets_to_include.mk
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args datasets='$(datasetsmsc)' conditions='$(conditionsmsc)' outrds='$@'" manuscript_results_figures/Rscripts/plot_sqanti_summary.R manuscript_results_figures/Rout/plot_sqanti_summary.Rout

manuscript_results_figures/figures/sqanti_round2_summary/sqanti_round2_summary.rds: \
$(foreach D,$(datasetsms),$(foreach S,$(D)_WT,$(D)/sqanti_round2/$(S)/$(S)_report.pdf)) \
Illumina/sqanti/Illumina_WT/Illumina_WT_report.pdf \
$(foreach D,$(datasetsms),$(foreach S,$(D)_WT,$(D)/sqanti_round2_ilmnjunc/$(S)/$(S)_ilmnjunc_report.pdf)) \
Illumina/output/Illumina_all_abundances.rds \
manuscript_results_figures/Rscripts/plot_sqanti_round2_summary.R \
manuscript_results_figures/Rscripts/remap_sample_names.R \
datasets_to_include.mk
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
...
datasets_to_include.mk
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args datasets='$(datasetsmsc)' conditions='$(conditionsmsc)' outrds='$@'" manuscript_results_figures/Rscripts/plot_compare_gffcompare_sqanti.R manuscript_results_figures/Rout/plot_compare_gffcompare_sqanti.Rout
...
manuscript_results_figures/figures/polya_tails/polya_tails.rds: \
RNA001/tailfindr/wt_1_RNA001_tailfindr.csv RNA001/nanopolish/wt_1_RNA001/pipeline-polya-ng/tails/filtered_tails.tsv \
manuscript_results_figures/Rscripts/plot_polya_tail_estimates.R
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args tx2gene='$(tx2gene)' outrds='$@'" manuscript_results_figures/Rscripts/plot_polya_tail_estimates.R manuscript_results_figures/Rout/plot_polya_tail_estimates.Rout

manuscript_results_figures/figures/palindromes/palindromes.rds: \
$(foreach D,$(datasetsms),$(D)/output/$(D)_nbr_reads.rds) \
manuscript_results_figures/Rscripts/plot_palindromes.R \
manuscript_results_figures/Rscripts/remap_sample_names.R
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args datasets='DCS108,RNA001' conditions='$(conditionsmsc)' nreads=100000 ncores=$(nthreads) outrds='$@'" manuscript_results_figures/Rscripts/plot_palindromes.R manuscript_results_figures/Rout/plot_palindromes.Rout

manuscript_results_figures/figures/gc_content_genomenotxome/gc_content_genomenotxome.rds: \
$(foreach D,DCS108,$(D)/FASTQgenomenotxome/reads_aligning_to_genome_but_not_txome.rds) \
manuscript_results_figures/Rscripts/plot_gc_content_genomenotxome.R \
manuscript_results_figures/Rscripts/remap_sample_names.R
	mkdir -p $(@D)
	mkdir -p manuscript_results_figures/Rout
	$(R) "--args datasets='DCS108' conditions='$(conditionsmsc)' outrds='$@'" manuscript_results_figures/Rscripts/plot_gc_content_genomenotxome.R manuscript_results_figures/Rout/plot_gc_content_genomenotxome.Rout
